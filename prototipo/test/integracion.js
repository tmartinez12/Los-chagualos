...
function pruebasSql() {
  ...
  const migs = ['migracion-nacimiento.sql', 'migracion-restaurar.sql', 'migracion-ganancia.sql', 'migracion-ciclo-vida.sql', 'migracion-movimientos-grupo.sql', 'migracion-vacunas-lista.sql', 'migracion-tratamiento-generico.sql'];
  for (const m of migs) {
