...
INSERT INTO animales (id, nombre, raza, grupo, sexo, edad_anios, origen, inicio_lactancia, estado_repro, prenez_meses, ultima_palpacion, peso_kg, fecha_peso, rol_toro, baja_motivo, baja_fecha, baja_valor, baja_nota) VALUES ('064', 'Cría de Lucero', 'Holstein × Gyr', 'cria', 'H', 0.42, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO animales (id, nombre, raza, grupo, sexo, edad_anios, origen, inicio_lactancia, estado_repro, prenez_meses, ultima_palpacion, peso_kg, fecha_peso, rol_toro, baja_motivo, baja_fecha, baja_valor, baja_nota) VALUES ('069', 'Cría de Estrella', 'Gyrolando', 'cria', 'H', 0.29, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO animales (id, nombre, raza, grupo, sexo, edad_anios, origen, inicio_lactancia, estado_repro, prenez_meses, ultima_palpacion, peso_kg, fecha_peso, rol_toro, baja_motivo, baja_fecha, baja_valor, baja_nota) VALUES ('071', 'Cría de Canela', 'Holstein × Gyr', 'cria', 'H', 0.38, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO animales (id, nombre, raza, grupo, sexo, edad_anios, origen, inicio_lactancia, estado_repro, prenez_meses, ultima_palpacion, peso_kg, fecha_peso, rol_toro, baja_motivo, baja_fecha, baja_valor, baja_nota) VALUES ('073', 'Cría de Morena', 'Normando', 'cria', 'H', 0.25, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
